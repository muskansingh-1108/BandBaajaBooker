            ...
            <div className="min-h-screen bg-gray-50 flex flex-col">
                ...
                <main className="grow container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <Routes>
                        ...
                        <Route path="*" element={<h1 className="text-4xl font-black text-center mt-32 text-gray-900">404 <span className="text-gray-400 font-medium">Page Not Found</span></h1>} />
                    </Routes>
                </main>
                <footer className="bg-natural-dark text-natural-bg py-16 mt-20 px-4">
                    <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                        ...
                        <p className="text-natural-bg/50 text-xs font-medium tracking-widest uppercase">© 2026 BandBaajaBooker. All celebrations secured.</p>
