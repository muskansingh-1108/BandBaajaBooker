...
const users = [
    { name: 'Admin User', email: 'admin@bandbaajabooker.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@bandbaajabooker.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@bandbaajabooker.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@bandbaajabooker.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@bandbaajabooker.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@bandbaajabooker.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@bandbaajabooker.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@bandbaajabooker.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@bandbaajabooker.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@bandbaajabooker.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        await mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/bandbaajabooker');
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@bandbaajabooker.com');
        console.log('User Email:  user@bandbaajabooker.com');
